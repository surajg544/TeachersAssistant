<?php
	...
	if(isset($_POST['submit1']))
	{
		...
		$query ="select * from addteacher where email ='$email' && MobileNum='$MobileNum'" ;
...
<head>
    ...
    <title>Teacher Assistant | Teacher Login</title>
...
<body>
	...
	<div class="heading">
		...
		<div class="header1"><h1><strong>Teacher Login</strong></h1><br></div>
		<form action="" method="POST">
		   <input type="email" name="email" class="form_input" placeholder="Email address" required><br><br>
		   <input type="Password" name="MobileNum" class="form_input" placeholder="Password" required><br><br>
		...
		<!-- <button name="submit1" type="button">Log in</button> -->
	</div>
	    <!-- JavaScript files-->
