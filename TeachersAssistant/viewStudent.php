...
<body>
	...
	<!-- sidebar start -->
		<div class="sidebar">
			<h5>Main</h5>
      <a href="viewStudent.php"><i class="fas fa-home"></i><span> Home</span></a>
	...
	<div class="container">
		<div class="header1"><h1><strong>VIEW STUDENT</strong></h1></div>
		<hr>
		<p>Show <select class="option" name="page" id="page">
         ...
         <?php
          ...
          $sql = "SELECT id, fullname, email, MobileNum, branch, year, record from studentreg";
